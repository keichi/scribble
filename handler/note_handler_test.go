...
func TestListNotes(t *testing.T) {
	...
	assert.Equal(notes[0].(map[string]interface{})["title"], "Test Title 1")
	assert.Equal(notes[1].(map[string]interface{})["title"], "Test Title 2")
	assert.Equal(notes[2].(map[string]interface{})["title"], "Test Title 3")
}
